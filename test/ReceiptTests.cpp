...
{
	/// \brief Pointer to TableInterface class to be used for interacting with the Receipt table
	Table receipt;

	/// \brief Unit test class for testing Receipt class
	...
	public:
		...
		/// \brief tests if the receipt class can add a row to the receipt table
